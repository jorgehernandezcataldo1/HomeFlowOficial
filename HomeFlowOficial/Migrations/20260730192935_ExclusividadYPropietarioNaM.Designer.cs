...
namespace HomeFlowOficial.Migrations
{
    ...
    [Migration("20260730192935_ExclusividadYPropietarioNaM")]
    partial class ExclusividadYPropietarioNaM
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HomeFlowOficial.Models.Inmueble", b =>
                {
                    ...
                    b.Property<bool>("TieneExclusividad")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HomeFlowOficial.Models.Propietario", b =>
                {
                    ...
                    b.HasIndex("PersonaId", "CorredorId")
                        .IsUnique();
            ...
            modelBuilder.Entity("HomeFlowOficial.Models.Propietario", b =>
                {
                    ...
                    b.HasOne("HomeFlowOficial.Models.Persona", "Persona")
                        .WithMany("RelacionesPropietario")
                        .HasForeignKey("PersonaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("HomeFlowOficial.Models.Persona", b =>
                {
                    ...
                    b.Navigation("RelacionesPropietario");
